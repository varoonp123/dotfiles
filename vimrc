...
"Make w!! force write with permission
cmap w!! %!sudo tee > /dev/null

"Tabs, Line Numbers, basic functionality and aesthetics
...
set showmatch		"highlight other parentesis/bracket/whatever when hovering over one
...
"AUTO HEADER
autocmd bufnewfile *.py so /usr/share/vim/header.txt
autocmd bufnewfile *.py exe "1," . 10 . "g/File Name :.*/s//File Name : " .expand("%")
autocmd bufnewfile *.py exe "1," . 10 . "g/Date Created :.*/s//Date Created : " .strftime("%m-%d-%Y")
